...
try{
  DataSourceDefinition = require('apiconnect/node_modules/loopback-workspace').models.DataSourceDefinition;
} catch(ex) {
    try{
  ...
  promptForDatasource : function()
  {
    ...
    var prompts = [{
      ...
      validate: function(input) {
                  var done = this.async();
                  if (input == "") {
                    done("You should provide a data source name");
                  }
                  done(null, true);
                }
    },{
      ...
      validate: function(input) {
                  var done = this.async();
                  if (input == "") {
                    done("You should provide hostname or IP Address");
                  }
                  done(null, true);
                }
    },{
      ...
      validate: function(input) {
                  var done = this.async();
                  if (isNaN(input)) {
                    done("You should provide a port number");
                  }
                  done(null, true);
                }
    },{
